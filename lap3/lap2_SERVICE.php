                ...
                <?php
                        ...
                        while($data = $query->fetch(PDO::FETCH_ASSOC))
                        {
                            ...
                            if(isset($selectch['arrival'])&&!is_null($selectch['arrival']))
                                ...
                                echo '<td><a href="lap1_chinar_arrive.php?racerno='.$uid.'"> <button disabled  class="btn btn-primary" type="button">'.$uid.': Stop</button></a> </td>';
                            //Chinar Start
                            ...
                            if(isset($selectch['arrival'])&&!is_null($selectch['arrival']))
                                ...
                                echo '<td><a href="lap2_sc_arrive.php?racerno='.$uid.'"> <button  class="btn btn-primary" type="button">'.$uid.': Stop</button></a> </td>';
                            //SC START
                            ...
                            if(isset($selectch['departure'])&&!is_null($selectch['departure']))
                                ...
                                echo '<td><a href="lap2_sc_depart.php?racerno='.$uid.'"> <button  class="btn btn-primary" type="button">'.$uid.': Start</button></a> </td>';
                            echo '</tr>';
