        ...
        <div class="container">
            ...
            <div class="table-responsive">
                ...
                <tr>
                    ...
                    <th colspan="1">HOTEL BEE TOWN</th>
                    
                
                
                </tr>
                <tr>
                    <th>TRANSPORT 5/6 START</th>
                    <th>TRANSPORT 5/6 STOP</th>
                    <th>STAGE 3/3 START</th>
                    <th>STOP</th>
                    <th>START</th>
                    <th>TRANSPORT 6/6 END <br><code>FINISH</code></th>
                    <!-- <th>SERVICE OUT</th> -->
                ...
                <tbody>
                        ...
                        while($data = $query->fetch(PDO::FETCH_ASSOC))
                        {
                            ...
                            if(isset($selectch['arrival'])&&!is_null($selectch['arrival']))
                                ...
                                echo '<td><a href="lap2_chinar_arrive.php?racerno='.$uid.'"> <button  class="btn btn-primary" type="button">'.$uid.': Stop</button></a> </td>';
                            //Chinar Start
                            ...
                            if(isset($selectch['departure'])&&!is_null($selectch['departure']))
                                ...
                                echo '<td><a href="lap2_chinar_depart.php?racerno='.$uid.'"> <button  class="btn btn-primary" type="button">'.$uid.': Start</button></a> </td>';
                            //FF Stop
